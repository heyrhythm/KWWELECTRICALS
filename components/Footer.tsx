...
const Footer = () => {
  return (
    <footer className="bg-slate-800 text-gray-300">
      {/* Main Footer Content */}
      <div className="lg:max-w-7xl mx-auto lg:px-4 lg:py-12 scale-65 md:scale-100 w-135 lg:w-full origin-top-left">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info - Left Section */}
          <div className="lg:col-span-2 scale-90 md:scale-100">
            {/* Logo */}
           <div className="flex items-center flex-shrink-0 lg:ml-4 lg:pb-5 ml-3 pb-2">
            ...
            <p className="text-gray-400 text-[14px] lg:text-sm mb-6 leading-relaxed">
              Leading manufacturer of energy-efficient electrical products in
              India.
              <br />
          ...
          {/* Middle Columns Container - Shifted Inward */}
          <div className="lg:flex grid grid-cols-2 lg:flex-col-2 lg:gap-6 lg:pl-8 lg:pr-4">
            {/* Our Products */}
