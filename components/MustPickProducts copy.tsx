...
//   // Expanded product data to 16 items
...
//   // Split products into two rows of 8 each
//   const row1Products = allProducts.slice(0, 8);
//   const row2Products = allProducts.slice(8, 16);
...
//   // Get visible products - now shows 4 cards (3 full + 1 half)
...
//   // Updated Arrow Button Component with proper event handling
//   const ArrowButton = ({ 
//     direction, 
//     onClick, 
//     disabled = false 
...
//         {/* Updated container with proper relative positioning */}
...
//         {/* Slide indicators - Updated for 8 products per row */}
